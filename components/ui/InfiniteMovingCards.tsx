...
export const InfiniteMovingCards = ({
  ...
  useEffect(() => {
    ...
    addAnimation(); // Call the function inside the effect
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[90vw] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-800 p-5 md:p-6 md:w-[60vw]"
            style={{
